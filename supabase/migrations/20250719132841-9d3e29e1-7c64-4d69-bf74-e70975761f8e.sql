...
-- Drop the default constraint temporarily and update the column type
...
ALTER TABLE public.profiles ALTER COLUMN user_type SET DEFAULT 'client'::public.user_type;

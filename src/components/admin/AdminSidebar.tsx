  ...
  return (
    <div className={cn("bg-card border-r w-64 min-h-screen", className)}>
      ...
      <nav className="p-4 space-y-2">
        ...
        <Link
          to="/"
          className="flex items-center px-3 py-2 text-sm font-medium rounded-md transition-colors bg-green-100 text-green-800 hover:bg-green-200 mb-4 border border-green-300"
        >

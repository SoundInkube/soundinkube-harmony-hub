...
const Index = () => {
  ...
  const featuredMusicProfessionals = [
    ...
    },
    {
      ...
      subtitle: 'Bollywood Music Director',
      image: artist2,
      rating: 4.9,
      location: 'Mumbai',
      genre: 'Bollywood',
  ...
  const topStudios = [
    {
      id: '1',
      title: 'SoundWave Studios Mumbai',
    ...
    {
      id: '5',
      title: 'Mystic Sounds Hyderabad',
      subtitle: 'Bollywood Specialist',
      image: studio1,
      rating: 4.6,
      location: 'Hyderabad',
      genre: 'Bollywood',
    ...
    {
      id: '6',
      title: 'Classical Corner Chennai',
      subtitle: 'Traditional Music Studio',
      image: studio1,
      rating: 4.9,
      location: 'Chennai',
      genre: 'Carnatic',
  ...
  const musicSchools = [
    ...
    },
    {
      id: '3',
      title: 'Raag Academy',
      subtitle: 'Hindustani Classical Music',
      image: school1,
      rating: 4.7,
      location: 'Kolkata',
      genre: 'Classical',
    ...
    {
      id: '4',
      title: 'Taal Music School',
      subtitle: 'Percussion & Rhythm',
      image: school1,
      rating: 4.8,
      location: 'Jaipur',
      genre: 'Percussion',
  ...
  const topLabels = [
    ...
    },
    {
      ...
      subtitle: 'Film Music Production',
      image: label1,
      rating: 4.9,
      location: 'Mumbai',
      genre: 'Bollywood',
    ...
    {
      id: '4',
      title: 'Classical Heritage Records',
      subtitle: 'Traditional Indian Music',
      image: label1,
      rating: 4.6,
      location: 'Chennai',
  ...
  const topJampads = [
    ...
    {
      id: '3',
      title: 'Beat Box Gurgaon',
      subtitle: 'Modern Jamming Facility',
      image: studio1,
      rating: 4.7,
      location: 'Gurgaon',
      genre: 'Hip-Hop & R&B',
    ...
    {
      id: '4',
      title: 'Music Lounge Pune',
      subtitle: 'Collaborative Music Space',
      image: studio1,
      rating: 4.6,
      location: 'Pune',
